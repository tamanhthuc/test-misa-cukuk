...
using MISA.WebFresher042023.Demo.Core.Attribute;
...
namespace MISA.WebFresher042023.Demo.Core.DTo
{
    ...
    public class EmployeeCreateDto
    {
        ...
        /// </summary>
        /// Created By: tmthuc (13/06/2023)
        [MaxDateToday(ErrorMessageResourceType = typeof(ResourceVN), ErrorMessageResourceName = nameof(ResourceVN.UserMsg_DateOfBirthMax))]
